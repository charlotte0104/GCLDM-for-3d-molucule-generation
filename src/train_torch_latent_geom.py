...
def save_checkpoint(model,optimizer,epoch,best_flag=False,mini_batch_flag=False):
    ...
    if best_flag==False:
        file_name="/tmp/pycharm_project_442/checkpoint_latent_geom/"+"{}_epoch.pth".format(epoch)
    else:
        if mini_batch_flag == True :
            file_name="/tmp/pycharm_project_442/checkpoint_latent_geom/"+"best_loss_mini_batch.pth"
        else :
            file_name = "/tmp/pycharm_project_442/checkpoint_latent_geom/" + "best_loss.pth"
...
def train(cfg: DictConfig) -> Tuple[dict, dict]:
    ...
    # model_para_path="/tmp/pycharm_project_442/checkpoint_latent_without_trained_vae/mini_2000/save/"+"best_loss_mini_batch.pth"
...
@hydra.main(version_base="1.3.2", config_path="../configs", config_name="train_torch_latent_geom.yaml")
