...
def evaluate(cfg: DictConfig) -> Tuple[dict, dict]:
    ...
    # cfg.datamodule.dataloader_cfg.dataset = "QM9_first_half"
    ...
    cfg.datamodule.dataloader_cfg.include_charges = False
    cfg.datamodule.dataloader_cfg.dataset = "QM9_second_half"
    datamodule_half: LightningDataModule = hydra.utils.instantiate(cfg.datamodule)
    datamodule_half.setup()
    ...
    # file_name = "/home/xiaofeng/pycharm_project/edm/checkpoint_latent_condition_qm9/gap/" + "best_loss_mini_batch.pth"
    # file_name = "/home/xiaofeng/pycharm_project/homo/ckpt/homo/" + "best_loss_mini_batch.pth"
    # file_name = "/home/xiaofeng/pycharm_project/edm/checkpoint_latent_condition_qm9/homo/" + "best_loss_mini_batch.pth"
    checkpoint = torch.load(cfg.generator_model_filepath,map_location=device)
    ...
    # props_norms = compute_mean_mad(
    #     dataloaders, list(cfg.model.module_cfg.conditioning), 'QM9_second_half'
    # )
