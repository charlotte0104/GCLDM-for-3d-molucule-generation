...
def compute_mean_mad_from_dataloader(
    ...
    torch.save(values, '/tmp/pycharm_project_80/data_for_distribution/data_Cv.pth')
...
def evaluate(cfg: DictConfig) :
    ...
    mean,mad,var=compute_mean_mad_from_dataloader(dataloaders['train'],'Cv')
    ...
    p=model.sample_and_compute_Cv(mean,mad,num_samples=1000)
    torch.save(p,'/tmp/pycharm_project_80/data_for_distribution/sample_Cv.pth')
    return {},{}
